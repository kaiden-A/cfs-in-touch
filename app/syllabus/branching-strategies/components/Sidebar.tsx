    ...
    <>
      ...
      `}>
        ...
        <div className="pt-20 lg:pt-16 px-6 mb-8 shrink-0">
          <h2 className="text-blue-500 font-bold font-space-grotesk text-sm uppercase tracking-widest">Module 3</h2>
          <p className="text-zinc-500 text-[10px] tracking-widest mt-1 uppercase">Branching Strategies</p>
        </div>
        ...
        <div className="flex-1 overflow-y-auto custom-scrollbar font-space-grotesk text-sm uppercase tracking-widest">
          <nav className="flex flex-col">
            ...
            {["What is Branch", "Handling Conflict", "Branching Workflow"].map(item => (
              <a 
                key={item} 
